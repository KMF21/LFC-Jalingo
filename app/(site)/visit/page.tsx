...
import ServiceTimesGrid from "@/components/ServiceTimesGrid";
...
export const metadata = {
  title: "Plan a Visit | Living Faith Church, Jalingo",
  description:
    "Service times, location, and what to expect when you visit Living Faith Church, Jalingo.",
};
    ...
    <main>
      ...
      <section className="bg-ink py-14">
        <div className="container-content">
          <Reveal>
            <p className="text-center text-sm font-semibold uppercase tracking-wide2 text-coral">You're invited</p>
      ...
      <section className="bg-paper-dim py-16">
        <div className="container-content max-w-2xl">
          <Reveal>
            <p className="text-center text-sm font-semibold uppercase tracking-wide2 text-red">Your experience</p>
      ...
      <section className="container-content grid grid-cols-1 gap-10 py-16 md:grid-cols-2">
        <Reveal>
          <p className="text-sm font-semibold uppercase tracking-wide2 text-red">Location</p>
        ...
        <Reveal delay={0.1}>
          <p className="mb-4 text-sm font-semibold uppercase tracking-wide2 text-red">First time?</p>
          <PlanVisitForm />
        </Reveal>
      </section>
