  ...
  return (
    <section className="bg-paper-dim py-16">
      <div className="container-content">
        <Reveal>
          <p className="text-sm font-semibold uppercase tracking-wide2 text-red">Ministries &amp; departments</p>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Reveal delay={0.1}>
              ...
              >
                ...
                <span className="mt-3 text-sm font-semibold text-paper/80 opacity-0 transition group-hover:opacity-100">
                  Learn more &rarr;
                </span>
              </Link>
            </Reveal>
