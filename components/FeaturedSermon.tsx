  ...
  return (
    <section className="bg-ink py-16">
      <div className="container-content grid grid-cols-1 gap-8 md:grid-cols-2 md:items-center">
        <Reveal>
          <p className="text-sm font-semibold uppercase tracking-wide2 text-coral">Latest message</p>
        ...
        <Reveal delay={0.1}>
          <div className="rounded-2xl border border-paper/15 bg-paper/5 p-6">
            ...
            <div className="mt-4 flex gap-3">
              <a
                href="/sermons"
                className="rounded-full bg-red px-4 py-2 text-sm font-semibold text-paper transition hover:bg-red-deep"
              >
                Browse all sermons
              </a>
              {sermon.pdfUrl && (
                <a
                  href={sermon.pdfUrl}
                  className="rounded-full border border-paper/25 px-4 py-2 text-sm font-semibold text-paper transition hover:border-paper"
                >
                  Download PDF notes
                </a>
              )}
